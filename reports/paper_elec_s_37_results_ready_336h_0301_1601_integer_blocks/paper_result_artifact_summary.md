...
- Input campaign directory used: `..\paper_elec_s_37_campaign_336h_integer_blocks_v2`
- Output directory: `reports/paper_elec_s_37_results_ready_336h_0301_1601_integer_blocks`
...
- FR: region_id=15, region_name=FR1 0, reason=top_wind_exposure
- DK: region_id=9, region_name=DK1 0, reason=top_wind_exposure
- BE: region_id=4, region_name=BE1 0, reason=top_solar_exposure
- DE: region_id=8, region_name=DE1 0, reason=top_solar_exposure
- BA: region_id=3, region_name=BA1 0, reason=top_local_utilization
...
- sigma_i^G: no full per-bus sigma artifact is stored; the 03.01--16.01 integer-block study uses the documented pure-Laplacian gSCR baseline with sigma_i^G=0 up to numerical tolerance, so zero was used for local ratio reconstruction.
...
- Local-ratio plot y-axis upper limit: 2.3; raw values are preserved in `paper_figure_1_timeseries_strength.csv`.
