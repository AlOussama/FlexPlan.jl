...
const _OUT_ROOT = normpath(@__DIR__, "..", "..", "reports", "paper_elec_s_37_campaign_336h")
const _RUNS = [
    ("H_336h_gmin_0p0", "BASE", "elec_s_37_2weeks_from_0301", 336, 0.0),
    ("H_336h_gmin_1p0", "gSCR-GERSH-1p0", "elec_s_37_2weeks_from_0301", 336, 1.0),
    ("H_336h_gmin_1p5", "gSCR-GERSH-1p5", "elec_s_37_2weeks_from_0301", 336, 1.5),
]
