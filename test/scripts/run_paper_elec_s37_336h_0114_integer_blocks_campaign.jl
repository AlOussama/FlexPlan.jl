...
const _DATA_ROOT = raw"D:\Projekte\Code\pypsatomatpowerx\data\flexplan_block_gscr"
const _OUT_ROOT = normpath(@__DIR__, "..", "..", "reports", "paper_elec_s_37_campaign_336h_0114_integer_blocks")
const _RUNS = [
    ("H_336h_gmin_0p0_integer_blocks", "BASE-INTEGER", "elec_s_37_2weeks_from_0114", 336, 0.0),
    ("H_336h_gmin_1p0_integer_blocks", "gSCR-GERSH-1p0-INTEGER", "elec_s_37_2weeks_from_0114", 336, 1.0),
    ("H_336h_gmin_1p5_integer_blocks", "gSCR-GERSH-1p5-INTEGER", "elec_s_37_2weeks_from_0114", 336, 1.5),
]
...
const _SELECTED_WEEKS_POLICY = "two_weeks_from_0114_with_preprocessed_fossil_exclusion"
...
function _run_one_case(git::Dict{String,Any}, run_name::String, scenario_name::String, case_dir::String, horizon_hours::Int, g_min::Float64)
    ...
    run_config = Dict(
        ...
        "selected_window_source" => "elec_s_37_2weeks_from_0114",
        "excluded_carriers" => _EXCLUDED_CARRIERS_REPORTED,
...
function _campaign_outputs(rows::Vector{Dict{String,Any}})
    ...
    open(normpath(_OUT_ROOT, "campaign_summary.md"), "w") do io
        ...
        println(io, "- selected_weeks_policy: ", _SELECTED_WEEKS_POLICY)
        println(io, "- source dataset: elec_s_37_2weeks_from_0114")
        println(io, "- excluded_carriers: coal, lignite, oil")
...
function main()
    ...
    for d in ["elec_s_37_2weeks_from_0114"]
