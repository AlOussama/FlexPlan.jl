...
const _OUT_ROOT = normpath(@__DIR__, "..", "..", "reports", "paper_elec_s_37_campaign_336h_integer_blocks_v2")
const _RUNS = [
    ("H_336h_gmin_1p0_integer_blocks", "gSCR-GERSH-1p0-INTEGER", "elec_s_37_2weeks_from_0301", 336, 1.0),
    ("H_336h_gmin_1p5_integer_blocks", "gSCR-GERSH-1p5-INTEGER", "elec_s_37_2weeks_from_0301", 336, 1.5),
]
