...
const INPUT_ROOT = normpath(@__DIR__, "..", "..", "reports", "paper_elec_s_37_campaign_336h")
const OUTPUT_ROOT = normpath(@__DIR__, "..", "..", "reports", "paper_elec_s_37_postprocessed_336h_0301_1601")

const CASES = [
    (label="BASE", run_dir="H_336h_gmin_0p0", gmin=0.0),
    (label="gSCR-GERSH-1.0", run_dir="H_336h_gmin_1p0", gmin=1.0),
    (label="gSCR-GERSH-1.5", run_dir="H_336h_gmin_1p5", gmin=1.5),
]
...
function write_summary(selected, local_plot_ymax, complete)
    ...
    open(normpath(OUTPUT_ROOT, "paper_result_artifact_summary.md"), "w") do io
        ...
        println(io, "- Output directory: `reports/paper_elec_s_37_postprocessed_336h_0301_1601`")
...
function main()
    ...
    println("study period: 03.01--16.01")
