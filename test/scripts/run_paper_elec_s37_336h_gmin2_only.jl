...
const _RUNS = [
    ("H_336h_gmin_2p0", "gSCR-GERSH", "elec_s_37_2weeks_from_0301", 336, 2.0),
]
...
function main()
    ...
    _write_json(normpath(_OUT_ROOT, "gmin2_run_summary.json"), Dict("generated_at" => Dates.format(now(), "yyyy-mm-ddTHH:MM:SS"), "rows" => rows))
